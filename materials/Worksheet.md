# 🧪 Disease Outbreak Challenge – Epidemiological Data Analysis

**Scenario:**  
An infectious disease is spreading through London in 1854. Hundreds of people fall ill within days.  
No one knows the cause, many suspect “bad air”. You are scientists trying to find patterns in the data to understand **who is most affected** and **how the disease spreads**.
...
Based on your visual exploration:
- Who seems most at risk?  
- Do you see hints of how the disease might spread?  
- What could be the **source**?

Write your hypothesis here:  
> _Example: People who eat less vegetables and live in households of 4 or more appear to get sick more often._

---

## Step 4: Test the Hypothesis (Statistical Check)
...
- If you were a real scientist, what **next data** would you want to collect?  
- How might this kind of analysis help in **modern public health**?
